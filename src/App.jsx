...
function App() {
  const allMovies = [
    ...
    // Romance (10)
    { id: 11, title: 'His & Hers', image: imageMap[11], category: 'romance', type: 'tv', description: 'Two strangers find love in unexpected circumstances in this heartwarming romance.', trailerUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', cast: 'Lucy Hale, Jake Allyn, Justin Hartley', year: 2024, seasons: 1, rating: 'TV-14', creator: 'Unknown' },
